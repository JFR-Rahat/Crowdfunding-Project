<?php
    ...
    $fetch = "SELECT * FROM `projectLaunchRequest` WHERE id=$projectId";
...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary shadow sticky-top">
        <div class="container-fluid">
            ...
            <div class="mx-auto">
                <a class="navbar-brand" href="../../client/pages/index.php"><b>Crowdfunding</b></a>
            </div>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="../../client/pages/start_project.php">Start A Project</a>
                    </li>
                </ul>
                ...
                <ul class="navbar-nav ms-2 ">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="../../client/user/userDashboard.php">User Dashboard</a></li>
                            <li>
                                <hr class="dropdown-divider" />
                            </li>
                            <li><a class="dropdown-item" href="../../client/pages/userLogOut.php">Logout</a></li>
                        </ul>
                    </li>
                </ul>
                <?php
            ...
            <div class="container">
                <div class="row gx-5 align-item-center">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div>Campaign Duration: <?php echo $campaignDuration; ?> Days</div>
