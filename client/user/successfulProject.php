        ...
        <!-- Sidebar End -->
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2">Successful Projects</h1>
                </div>
                        ...
                        <table class="table table-hover w-auto mw-100">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    if(isset($_SESSION["ownerSuccessfulProjects"])){
                                        if($_SESSION["ownerSuccessfulProjects"][0] != "Empty"){
                                             
                                            $projects = $_SESSION["ownerSuccessfulProjects"];
                                    ...
                                    ?>
                                        <script>
                                        window.location = "../../contracts/getOwnerSuccessfulProject.php";
                                        </script>
                                    <?php
                                    }
                                ?>
