        ...
        <!-- Sidebar End -->
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2">My Funded Successful Projects</h1>
                </div>
                        ...
                        <table class="table table-hover w-auto mw-100">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    if(isset($_SESSION["fundedSuccessfulProjects"])){
                                        if($_SESSION["fundedSuccessfulProjects"][0] != "Empty"){
                                        
                                            $projects = $_SESSION["fundedSuccessfulProjects"];
                                        ...
                                        ?>
                                        <script>
                                            window.location = "../../contracts/getFundedSuccessfulProject.php";
                                        </script>
                                        <?php
                                    }
