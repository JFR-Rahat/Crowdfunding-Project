        ...
        <!-- Sidebar End -->
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2">Claimed Projects</h1>
                </div>
                        ...
                        <table class="table table-hover w-auto mw-100">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    if(isset($_SESSION["ownerClaimedProjects"])){
                                        if($_SESSION["ownerClaimedProjects"][0] != "Empty"){
                                        
                                            $projects = $_SESSION["ownerClaimedProjects"];
                                        ...
                                        ?>
                                        <script>
                                            window.location = "../../contracts/getClaimedProject.php";
                                        </script>
                                        <?php
                                    }
