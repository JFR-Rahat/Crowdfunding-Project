        ...
        <!-- Sidebar End -->
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2">My Funded Ongoing Projects</h1>
                </div>
                        ...
                        <table class="table table-hover w-auto mw-100">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    if(isset($_SESSION["fundedOngoingProjects"])){
                                        if($_SESSION["fundedOngoingProjects"][0] != "Empty"){
                                        
                                            $projects = $_SESSION["fundedOngoingProjects"];
                                        ...
                                        ?>
                                        <script>
                                            window.location = "../../contracts/getFundedOngoingProject.php";
                                        </script>
                                        <?php
                                    }
