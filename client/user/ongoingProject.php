        ...
        <!-- Sidebar End -->
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2">Ongoing Projects</h1>
                </div>
                        ...
                        <table class="table table-hover w-auto mw-100">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    if(isset($_SESSION["ownerProjects"])){
                                        if($_SESSION["ownerProjects"][0] != "Empty"){
                                        
                                            $projects = $_SESSION["ownerProjects"];
                                        ...
                                        ?>
                                        <script>
                                            window.location = "../../contracts/getOwnerProject.php";
                                        </script>
                                        <?php
                                    }
