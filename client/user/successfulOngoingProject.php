        ...
        <!-- Sidebar End -->
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2">Successful Ongoing Projects</h1>
                </div>
                        ...
                        <table class="table table-hover w-auto mw-100">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    if(isset($_SESSION["ownerSuccessfulOngoigProjects"])){
                                        if($_SESSION["ownerSuccessfulOngoigProjects"][0] != "Empty"){
                                             
                                            $projects = $_SESSION["ownerSuccessfulOngoigProjects"];
                                        ...
                                        ?>
                                                ...
                                                <td><img src="<?php echo "../../server/".$projectPhotoDir; ?>" alt=""
                                                        class="img-fluid rounded-circle" width=100 height=auto></td>
                                                <td scope="col"><?php echo $projectOwnerName; ?></td>
                                                <td scope="col">
                                                    <?php echo substr($projectOwnerAddress, 0, 5) . "......" . substr($projectOwnerAddress, strlen($projectOwnerAddress)-6, 5); ?>
                                                </td>
                                                <td scope="col"><?php echo $projectTitle; ?></td>
                                                <td scope="col"><?php echo $projectCategory; ?></td>
                                                <td scope="col"><?php echo $projectStory; ?></td>
                                                <td scope="col">
                                                    <?php echo substr($projectFundingGoal, 0, strlen($projectFundingGoal)-15); ?> Finney
                                                </td>
                                                <td scope="col"><?php echo date("Y-m-d H:i:s", substr($projectStartTime, 0, 10)); ?>
                                                </td>
                                                ...
                                                <td><button type="button" class="btn btn-outline-success" disabled
                                                        onclick=claimFund(<?php echo $projectId;?>)>Claim Fund</button></td>
                                    ...
                                    ?>
                                        <script>
                                        window.location = "../../contracts/getOwnerSuccessfulOngoingProject.php";
                                        </script>
                                    <?php
                                    }
                                ?>
