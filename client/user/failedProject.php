<?php
    ...
    // include_once("../../contracts/getOwnerFailedProject.php");
?>
        ...
        <!-- Sidebar End -->
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2">Failed Projects</h1>
                </div>
                        ...
                        <table class="table table-hover w-auto mw-100">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    if(isset($_SESSION["ownerFailedProjects"])){
                                        if($_SESSION["ownerFailedProjects"][0] != "Empty"){
                                        
                                            $projects = $_SESSION["ownerFailedProjects"];
                                    ...
                                    <?php
                                        ...
                                        ?>
                                        <script>
                                            window.location = "../../contracts/getOwnerFailedProject.php";
                                        </script>
                                        <?php
                                    }
